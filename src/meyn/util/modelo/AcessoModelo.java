...
public interface AcessoModelo {
    ...
    /**
     * Equivalente a {@link
     * AcessoModelo#consultarPorChavePrimaria(meyn.util.modelo.ot.OT,String,meyn.util.modelo.ot.OT)
    ...
    /**
     * Equivalente a {@link
     * AcessoModelo#incluir(meyn.util.modelo.ot.OT,String,meyn.util.modelo.ot.OT)
    ...
    /**
     * Equivalente a {@link
     * AcessoModelo#alterar(meyn.util.modelo.ot.OT,String,meyn.util.modelo.ot.OT)
    ...
    /**
     * Equivalente a {@link
     * AcessoModelo#excluir(meyn.util.modelo.ot.OT,String,meyn.util.modelo.ot.OT)
