...
/**
 * Cache de objetos da camada dos modelos. O cache é mantido no contexto da
 * aplicação JEE, vinculado ao nome desta classe. É garantida a existência de
 * <b>um único cache por <i>class loader</i></b>.
 * 
