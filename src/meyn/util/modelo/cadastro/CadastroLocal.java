...
public abstract class CadastroLocal extends CadastroImpl {
    ...
    /**
     * Chamado por {@link
     * CadastroLocal#consultarTodos(meyn.util.modelo.ot.OT,meyn.util.modelo.ot.OT) consultarTodos}.
     */
    ...
    /**
     * Chamado por {@link
     * CadastroLocal#consultarPorChavePrimaria(meyn.util.modelo.ot.OT,
     * meyn.util.modelo.ot.OT,meyn.util.modelo.ot.OT) consultarPorChavePrimaria}.
     */
    ...
    /**
     * Chamado por {@link CadastroLocal#incluir(meyn.util.modelo.ot.OT,
     * meyn.util.modelo.ot.OT) incluir}.
     */
    ...
    /**
     * Chamado por {@link CadastroLocal#alterar(meyn.util.modelo.ot.OT,
     * meyn.util.modelo.ot.OT) alterar}.
     */
    ...
    /**
     * Chamado por {@link CadastroLocal#excluir(meyn.util.modelo.ot.OT,
     * meyn.util.modelo.ot.OT) excluir}.
     */
